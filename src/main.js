...
function updateWeatherUI(data) {
  ...
  // Use if-else instead of object mapping
  if (weatherCondition === "clouds") {
    ...
    weatherIcon.src = "/src/images/clear.png"; // Default image
  }
}
...
//   weatherIcon.src = weatherImages[weatherCondition] || "/src/images/clear.png";
// }
